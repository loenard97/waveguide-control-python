...
XI_SENSOR_FEATURE_SELECTOR = { 
    ...
    "XI_SENSOR_FEATURE_AUTO_LOW_POWER_MODE_AUTO": c_uint(8),    #Sensor low power mode
    "XI_SENSOR_FEATURE_HIGH_CONVERSION_GAIN": c_uint(9),    #Sets sensor high conversion gain
    }
